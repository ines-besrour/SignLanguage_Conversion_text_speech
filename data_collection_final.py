...
count = len(oss.listdir("AtoZ_3.0\\A\\"))
c_dir = 'A'
...
cv2.imwrite("C:\\Users\heha\OneDrive\Desktop\Sign-Language-To-Text-and-Speech-Conversion\white.jpg",white)
...
while True:
    try:
        ...
        white = cv2.imread("C:\\Users\heha\OneDrive\Desktop\Sign-Language-To-Text-and-Speech-Conversion\white.jpg")
